...
public class Explodable : MonoBehaviour
{
    ...
    public void explode()
    {
        ...
        else
        {
            ...
            {
                Vector2 inheritVel = frag.transform.parent.GetComponent<Rigidbody2D>().velocity;
                frag.transform.parent = null;
                frag.SetActive(true);
                frag.GetComponent<Rigidbody2D>().velocity = inheritVel;
            }
        }
    ...
    private void generateFragments()
    {
        ...
        foreach (GameObject p in fragments)
        {
            if (p != null)
            {
                ...
                p.GetComponent<Rigidbody2D>().drag = 1f;
            }
        }
